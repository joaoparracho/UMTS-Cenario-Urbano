...
FILE_NAME = 'umtsTestBA';

SIGNAL_COVERAGE_LEVELS = -120 + (-10 +100).*rand(400,400);
...
%% ========================================================================
%% Get coordinates vectors from BASE STATIONS
%% ========================================================================
