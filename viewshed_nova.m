function [vismap, R] = viewshed_nova(Z, R, lat1, lon1, ...
...
if nargin > 6
    oaltopt = convertStringsToChars(oaltopt);
end

if nargin > 7
    taltopt = convertStringsToChars(taltopt);
end
...
% a = 1.5:2:1024.5;
% vismap = interp2(inpaint_nans(vismap), repmat(a, 512, 1), repmat(a', 1, 512), 'nearest');
